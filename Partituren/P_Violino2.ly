		...
		\score {
			\new StaffGroup {
				\new Staff {
					...
					\compressFullBarRests \NisiDominusViolinoII
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino II"
					\compressFullBarRests \VanumEstViolinoII
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino II"
					\compressFullBarRests \CumDederitViolinoII
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino II"
					\compressFullBarRests \SicutSagittaeViolinoII
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino II"
					\compressFullBarRests \BeatusVirViolinoII
				}
			}
		}
	}
	\bookpart {
		\paper { indent = 3\cm systems-per-page = #7 }
		\header {
			...
			<<
				\new StaffGroup <<
					\new Staff {
						...
						\compressFullBarRests \GloriaPatriViolinoIISolo
					}
					\new Staff {
						\set Staff.instrumentName = "Violino II"
						\override Staff.VerticalAxisGroup #'minimum-Y-extent = #'(-10 . 4)
						\compressFullBarRests \GloriaPatriViolinoII
					}
				>>
			>>
		}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino II"
					\compressFullBarRests \SicutEratViolinoII
				}
			}
		}
	}
