		...
		\score {
			\new StaffGroup {
				\new Staff {
					...
					\compressFullBarRests \NisiDominusViola
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \VanumEstViola
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \CumDederitViola
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \SicutSagittaeViola
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \BeatusVirViola
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \GloriaPatriViola
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Viola"
					\compressFullBarRests \SicutEratViola
				}
			}
		}
	}
