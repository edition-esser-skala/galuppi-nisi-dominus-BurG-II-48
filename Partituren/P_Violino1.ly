		...
		\score {
			\new StaffGroup {
				\new Staff {
					...
					\compressFullBarRests \NisiDominusViolinoI
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \VanumEstViolinoI
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \CumDederitViolinoI
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \SicutSagittaeViolinoI
				}
			}
		}
	}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \BeatusVirViolinoI
				}
			}
		}
	}
			...
			<<
				\new StaffGroup <<
					\new Staff {
						...
						\compressFullBarRests \GloriaPatriViolinoISolo
					}
					\new Staff {
						\set Staff.instrumentName = "Violino I"
						\override Staff.VerticalAxisGroup #'minimum-Y-extent = #'(-10 . 4)
						\compressFullBarRests \GloriaPatriViolinoI
					}
				>>
			>>
		}
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\accidentalStyle Score.modern-voice
					\set Staff.instrumentName = "Violino I"
					\compressFullBarRests \SicutEratViolinoI
				}
			}
		}
	}
