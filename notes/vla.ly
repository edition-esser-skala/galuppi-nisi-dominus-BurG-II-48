...
CumDederitViola = {
  \relative c' {
    ...
    es4 r r e?8 g
    f a e g f a e g
    f4 f16\f es d c b b'\pE a g f es d c
    b4 r r16 b' a g f es d c
    b4 r d8 d d d %240
    ...
    f1\fermata
    f8 b g c f, a b c
    b g c, c d4 r\fermata \bar "|." %260 finis
  }
}
